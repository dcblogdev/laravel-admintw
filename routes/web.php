...
Livewire::setUpdateRoute(function ($handle) {
    return Route::post('livewire/update', $handle)
        ->middleware(RolePermissions::class);
});

Route::get('/', WelcomeController::class);

Route::prefix(config('admintw.prefix'))->middleware([Authenticate::class, ActiveUser::class, IpCheckMiddleware::class])->group(function () {
