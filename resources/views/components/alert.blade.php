@php
    ...
    $class .= " " . match($attributes->get("variant")) {
        ...
        'red' => "bg-red-500 text-red-200 dark:bg-red-700 dark:text-red-100",
        'yellow' => "bg-yellow-500 text-yellow-200 dark:bg-yellow-600 dark:text-yellow-100",
        'green' => "bg-green-500 text-green-200 dark:bg-green-700 dark:text-green-100",
        'blue' => "bg-blue-500 text-blue-200 dark:bg-blue-700 dark:text-blue-100",
